...
import { endsWithNewLine } from "@starter/common/dist/string.helpers";
...
export async function copyFiles(files: string[], base: string, dest: string, concurrency: number = 25): Promise<void> {
